...
// covers.openlibrary.org URL at render time), and a bookNotes entry that's
// actually *about that book's story* — real plot/theme content (not a
// generic placeholder), for stress-testing a future "analyze my book notes"
// feature (same idea as the existing sentence-analysis one) with something
// worth summarizing instead of one repeated filler line.
type SeedBookSource = SuggestedBook & { coverId: number; bookNotes: string };
...
const SEED_BOOKS: SeedBookSource[] = [
    { title: "Pride and Prejudice", author: "Jane Austen", year: "1813", coverId: 14348537, bookNotes: "Elizabeth's first impression of Darcy — proud, aloof, insufferable — takes the whole book to unravel. Turns out half of what she 'knew' about him came from Wickham's lies. The real turning point isn't the first proposal, it's the letter afterward. Loved how Charlotte's practical marriage to Mr. Collins sits right next to Lydia's reckless one, as a quiet argument about what marriage is actually for." },
    { title: "Moby-Dick", author: "Herman Melville", year: "1851", coverId: 10544254, bookNotes: "Ahab isn't hunting a whale, he's hunting the idea that something can wrong him and get away with it. Ishmael survives by accident — floating on Queequeg's coffin — which feels like the whole point: obsession sinks the ship, chance decides who lives. The whaling-industry chapters dragged for me, but they make the Pequod feel like a real, doomed little world." },
    { title: "Frankenstein", author: "Mary Shelley", year: "1818", coverId: 12356249, bookNotes: "The 'monster' reads for a while, learns language, wants companionship — and Victor still won't look at him. That's the real horror, not the stitching-together part. Every death after the creature is abandoned traces straight back to that first refusal. Victor chasing his own creation across the ice at the end felt less like justice and more like neither of them knowing how to stop." },
    { title: "Dracula", author: "Bram Stoker", year: "1897", coverId: 12216503, bookNotes: "Told entirely through letters and journal entries, which makes Lucy's slow decline genuinely unsettling — you're piecing it together at the same pace the characters are. Van Helsing is basically the only one who takes the supernatural seriously early enough to matter. Mina typing up everyone's notes to build the case against the Count is such a satisfyingly modern, procedural way to beat a Gothic villain." },
    { title: "The Adventures of Sherlock Holmes", author: "Arthur Conan Doyle", year: "1892", coverId: 6717853, bookNotes: "Irene Adler is the one who got away — outwitting Holmes in 'A Scandal in Bohemia' and staying 'the woman' to him ever after. The Red-Headed League story is my favorite pure puzzle: an absurd hiring scheme that's actually cover for a bank vault tunnel. What holds the collection together is Watson's admiration doing double duty as the reader's own astonishment." },
    { title: "Great Expectations", author: "Charles Dickens", year: "1861", coverId: 13322313, bookNotes: "Pip spends the whole book assuming Miss Havisham made him a gentleman, when it was actually Magwitch — the convict he helped as a scared kid on the marshes. That reveal recolors everything: his shame about Joe, his chasing Estella, all built on a story he told himself. Miss Havisham frozen at her own wedding-that-never-happened is one of the bleakest images in the book." },
    { title: "Jane Eyre", author: "Charlotte Brontë", year: "1847", coverId: 8235363, bookNotes: "Jane walks out on Rochester at the altar the second she learns about Bertha in the attic — and that's the whole character in one act: she won't trade her self-respect for love, even love she clearly wants. The Gothic stuff (the fire, the mad wife, the mysterious laughter) works because it's really about what Rochester's been hiding, not ghosts. Her returning only once she's his equal, not his dependent, is the real ending." },
    { title: "Wuthering Heights", author: "Emily Brontë", year: "1847", coverId: 12818862, bookNotes: "Heathcliff and Catherine's love isn't tender, it's consuming — she says 'I am Heathcliff,' not 'I love him.' When she marries Edgar Linton for status instead, his revenge doesn't stop with her; it swallows the next generation too. Nelly telling the whole thing secondhand, years later, makes you constantly wonder how much she's shading the story." },
    { title: "The Picture of Dorian Gray", author: "Oscar Wilde", year: "1890", coverId: 14314858, bookNotes: "The portrait ages and rots with every cruelty Dorian commits, while his own face stays perfect — so his sins become literally invisible to everyone but him. Lord Henry's cynical one-liners are what actually corrupt him, more than any single act. Stabbing the painting and dying in his true, ruined form instead of it is the cleanest 'you can't outrun what you are' ending I've read." },
    { title: "Crime and Punishment", author: "Fyodor Dostoevsky", year: "1866", coverId: 9411873, bookNotes: "Raskolnikov murders the pawnbroker to prove his theory that 'extraordinary' men are above ordinary morality — and then can't live with what he's done, which sort of disproves the theory on the spot. Porfiry the investigator never even needs hard evidence; he just lets Raskolnikov's guilt do the work. Sonya's quiet, unglamorous faith is what finally gets him to confess, not fear of getting caught." },
    { title: "War and Peace", author: "Leo Tolstoy", year: "1869", coverId: 12621906, bookNotes: "Pierre's search for meaning — through masonry, through the war, through captivity — is the emotional spine under all the battle chapters. Andrei's arc (glory-seeking, then wounded and staring at the sky, then falling for Natasha) is the most affecting thread for me. Tolstoy keeps interrupting the story to argue that history isn't made by great men at all, which is a strange, bold thing for a novel this size to insist on." },
    { title: "Anna Karenina", author: "Leo Tolstoy", year: "1877", coverId: 2560652, bookNotes: "Anna's affair with Vronsky starts as liberation and ends as total isolation — society punishes her while barely touching him. The Levin-Kitty chapters, especially the mowing-the-field scene, are the quiet counterweight: a slower, less romantic, more durable kind of love. That opening line about happy families is basically the whole book's thesis." },
    { title: "The Odyssey", author: "Homer", year: "-800", coverId: 9045853, bookNotes: "Odysseus is clever to a fault — the Cyclops only becomes a lasting problem because he can't resist bragging his real name on the way out. Penelope holding off the suitors by unweaving her loom each night is the same kind of cunning, just aimed at surviving rather than escaping. Telemachus's own journey, growing into someone his father would recognize, is easy to skim past but it's doing real work." },
    { title: "Don Quixote", author: "Miguel de Cervantes", year: "1605", coverId: 14428305, bookNotes: "The windmills-as-giants scene is famous for a reason, but what stuck with me more is how Sancho Panza slowly stops just humoring the old man and starts half-believing the fantasy too. It reads as a parody of chivalric romances, but Quixote's insistence on seeing the world as more meaningful than it is starts to feel less foolish and more like a choice by the end." },
    { title: "Alice's Adventures in Wonderland", author: "Lewis Carroll", year: "1865", coverId: 10527843, bookNotes: "Almost nothing in Wonderland follows its own rules for more than a page — the Mad Hatter's tea party, the Cheshire Cat fading to just a grin, the trial where the verdict comes before the evidence. Alice staying reasonable and slightly exasperated through all of it is what makes the nonsense funny instead of just chaotic. The 'it was all a dream' ending feels almost beside the point." },
    { title: "The Time Machine", author: "H. G. Wells", year: "1895", coverId: 9009316, bookNotes: "The gentle, childlike Eloi and the predatory underground Morlocks turn out to be one species split by class into prey and predator — a nasty extrapolation of Victorian inequality. The traveler assumes he's found a peaceful utopia for about five minutes before realizing why the Eloi are so afraid of the dark. Going even further forward, to a dying, silent Earth, is the bleakest gut-punch in the book." },
    { title: "The War of the Worlds", author: "H. G. Wells", year: "1898", coverId: 36314, bookNotes: "The tripods and heat-rays are unstoppable by anything humanity throws at them — artillery, ironclads, none of it matters. What finally kills the Martians is bacteria, something so small no one even thought to be afraid of it. The narrator wandering the emptied, ash-covered Surrey countryside is scarier to me than any of the actual invasion scenes." },
    { title: "A Tale of Two Cities", author: "Charles Dickens", year: "1859", coverId: 13301713, bookNotes: "Sydney Carton spends most of the book as a wasted, self-loathing drunk, which makes his ending — quietly taking Darnay's place at the guillotine for Lucie's sake — land so much harder. The 'it is a far, far better thing' line only works because you've watched him believe he was worth nothing right up until he does the one thing that matters. The Revolution's mob violence is portrayed as both a righteous uprising and a monster that eats its own." },
    { title: "Oliver Twist", author: "Charles Dickens", year: "1837", coverId: 13300802, bookNotes: "Oliver asking for 'more' gruel is the image everyone remembers, but the real engine of the book is Fagin's gang teaching a starving orphan to pick pockets as a kind of found family, twisted as it is. Nancy's death for trying to protect Oliver is the moment the book stops being satire and gets genuinely brutal. His 'true,' more comfortable parentage being revealed at the end always felt like a slightly too-neat bow on a messy story." },
    { title: "The Count of Monte Cristo", author: "Alexandre Dumas", year: "1844", coverId: 14566393, bookNotes: "Dantès spends fourteen years in the Château d'If for a crime he didn't commit, and comes out having turned that entire betrayal into a methodical, patient revenge plan against all three men responsible. What makes it more than a straightforward revenge story is watching him start to question, near the end, whether becoming an instrument of 'Providence' has cost him his own humanity." },
    { title: "The Three Musketeers", author: "Alexandre Dumas", year: "1844", coverId: 11929973, bookNotes: "D'Artagnan starts the book dueling all three musketeers separately before they become inseparable — a great little joke about hot-headed young men. The diamond-studs errand for the Queen is the plot engine, but Milady de Winter is the real threat: cunning, ruthless, and always a step ahead until the very end. 'All for one, one for all' earns its cliché status here." },
    { title: "Little Women", author: "Louisa May Alcott", year: "1868", coverId: 8775559, bookNotes: "Jo turning down Laurie's proposal is the moment I actually respected the book — she knows exactly what she wants (to write, to be herself) and refuses to settle just because it's expected. Beth's illness and death hit differently on a reread, once you know it's coming the whole time. Amy growing from the 'spoiled little sister' into someone genuinely thoughtful is more interesting than I remembered." },
    { title: "The Scarlet Letter", author: "Nathaniel Hawthorne", year: "1850", coverId: 5654516, bookNotes: "Hester wears her shame openly — the embroidered A — while Dimmesdale hides his and it slowly destroys him from the inside, which is the book's whole argument about public versus private guilt. Chillingworth's quiet, patient cruelty as he figures out who the father is and torments him for it is genuinely chilling. Pearl always felt less like a child and more like a walking symbol to me, which I think is intentional but still kept her at arm's length." },
    { title: "Heart of Darkness", author: "Joseph Conrad", year: "1899", coverId: 12307847, bookNotes: "The trip up the Congo is framed as a search for the ivory trader Kurtz, but it plays like a slow unmasking of exactly what colonial 'civilization' actually looks like once no one's watching. Kurtz's 'The horror! The horror!' lands as an verdict on himself, not just a dying man's confusion. Marlow telling this story after the fact, aboard a boat on the Thames, quietly implicates London too." },
    { title: "Treasure Island", author: "Robert Louis Stevenson", year: "1883", coverId: 13859660, bookNotes: "Long John Silver is the character that makes this one stick — genuinely charming, genuinely dangerous, and never fully trustworthy even after he's supposedly switched sides. Jim overhearing the mutiny plot from inside the apple barrel is the kind of lucky, tense set piece the whole book runs on. The treasure itself almost feels beside the point next to who survives to spend it." },
    { title: "The Strange Case of Dr Jekyll and Mr Hyde", author: "Robert Louis Stevenson", year: "1886", coverId: 295773, bookNotes: "Knowing the twist going in almost makes it more interesting — you're watching Utterson piece together something the reader already suspects. Jekyll's own account at the end reframes the whole book: he didn't create Hyde to do evil safely, he created him because the potion let him stop pretending he wasn't already capable of it. The fact that Hyde starts taking over without the potion, near the end, is the real horror." },
    { title: "Gulliver's Travels", author: "Jonathan Swift", year: "1726", coverId: 12717083, bookNotes: "Lilliput's tiny, petty court obsessing over which end of an egg to crack is such a sharp jab at real political squabbling scaled down to absurdity. Brobdingnag flips the joke by making Gulliver himself the small, ridiculous one, describing human wars and cruelty to a giant king who's horrified by them. By the Houyhnhnms section Gulliver's basically disgusted with his own species, which felt like the darkest turn in the book." },
    { title: "The Wonderful Wizard of Oz", author: "L. Frank Baum", year: "1900", coverId: 552443, bookNotes: "The Scarecrow, Tin Man, and Lion each already have the thing they think they're missing — brains, heart, courage — and the book knows it long before they do. The Wizard turning out to be a fraud behind a curtain, not a magician, is a nice twist for a story ostensibly about magic. Dorothy having the power to go home the whole time (the silver shoes) makes the whole journey feel a bit like it was never really about Oz at all." },
    { title: "Peter Pan", author: "J. M. Barrie", year: "1911", coverId: 8237052, bookNotes: "Peter's refusal to grow up reads as a lot more melancholy than the Disney version — he forgets people, forgets his own adventures, forgets Wendy entirely by the time he comes back for her. Captain Hook is almost sympathetic, obsessively terrified of the crocodile and its ticking clock, i.e. of time itself. Wendy choosing to grow up and go home is framed as the actual brave choice, not a loss." },
    { title: "The Legend of Sleepy Hollow", author: "Washington Irving", year: "1820", coverId: 8243083, bookNotes: "Ichabod Crane is superstitious, greedy, and mostly interested in Katrina Van Tassel's family farm — not exactly a sympathetic hero, which makes his fate land more like comeuppance than tragedy. The story never confirms whether the Headless Horseman is real or just Brom Bones in disguise scaring off a rival, and I like that it doesn't bother clearing that up. Either way, Ichabod's gone from Sleepy Hollow for good." },
];
...
function buildSeedBook(index: number): ReadListBook {
    ...
    if (status === "read") {
        ...
        if (Math.random() < 0.3) {
            book.bookNotes = source.bookNotes;
        }
    }
    return book;
}
